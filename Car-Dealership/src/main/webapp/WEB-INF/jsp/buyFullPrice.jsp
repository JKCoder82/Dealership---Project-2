...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  ...
  <main class="px-3">
    ...
    <p class="lead text-white">Shop with us today for the deal of a lifetime!</p>
   
  </main>
  
  	
			 	<p>
				<img src="${vehicleInfo.image }"><br>
				  Model:
...
<form:form method="post" action="/thankYou" modelAttribute="buyer">
